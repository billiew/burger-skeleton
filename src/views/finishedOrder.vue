<template>
  <div id="orders">
    ...
    <center >
      <button class="theButtons" v-on:click="changePageToOrder()"><h1>{{uiLabels.newMenu}}</h1></button>
      <button class="theButtons" v-on:click="changePageToStart()"><h1>{{uiLabels.finish}}</h1></button>
    </center>
  </div>
</template>
<script>
